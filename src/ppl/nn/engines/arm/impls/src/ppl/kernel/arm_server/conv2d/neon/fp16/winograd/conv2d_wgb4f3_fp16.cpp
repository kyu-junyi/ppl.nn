    ...
    const uint32_t fuse_flag)
{
    ...
    switch (num_valid_oh) {
        case 4:
            switch (num_valid_ow) {
                case 4:
                    vst1q_f16(output_block + outW * (3 * OCVL()) + (3 * OCVL()), vmid[9]);
                    __attribute__((fallthrough));
                case 3:
                    vst1q_f16(output_block + outW * (3 * OCVL()) + (2 * OCVL()), vmid[8]);
                    __attribute__((fallthrough));
                case 2:
                    vst1q_f16(output_block + outW * (3 * OCVL()) + (1 * OCVL()), vmid[7]);
                    __attribute__((fallthrough));
                case 1:
                    vst1q_f16(output_block + outW * (3 * OCVL()), vmid[6]);
                    __attribute__((fallthrough));
                default:;
            }
            __attribute__((fallthrough));
        case 3:
            switch (num_valid_ow) {
                case 4:
                    vst1q_f16(output_block + outW * (2 * OCVL()) + (3 * OCVL()), vmid[5]);
                    __attribute__((fallthrough));
                case 3:
                    vst1q_f16(output_block + outW * (2 * OCVL()) + (2 * OCVL()), vmid[4]);
                    __attribute__((fallthrough));
                case 2:
                    vst1q_f16(output_block + outW * (2 * OCVL()) + (1 * OCVL()), vmid[3]);
                    __attribute__((fallthrough));
                case 1:
                    vst1q_f16(output_block + outW * (2 * OCVL()), vmid[2]);
                    __attribute__((fallthrough));
                default:;
            }
            __attribute__((fallthrough));
        case 2:
            switch (num_valid_ow) {
                case 4:
                    vst1q_f16(output_block + outW * (OCVL()) + (3 * OCVL()), vmid[1]);
                    __attribute__((fallthrough));
                case 3:
                    vst1q_f16(output_block + outW * (OCVL()) + (2 * OCVL()), vmid[0]);
                    __attribute__((fallthrough));
                case 2:
                    vst1q_f16(output_block + outW * (OCVL()) + (1 * OCVL()), vio[5]);
                    __attribute__((fallthrough));
                case 1:
                    vst1q_f16(output_block + outW * (OCVL()), vio[4]);
                    __attribute__((fallthrough));
                default:;
            }
            __attribute__((fallthrough));
        case 1:
            switch (num_valid_ow) {
                case 4:
                    vst1q_f16(output_block + (3 * OCVL()), vio[3]);
                    __attribute__((fallthrough));
                case 3:
                    vst1q_f16(output_block + (2 * OCVL()), vio[2]);
                    __attribute__((fallthrough));
                case 2:
                    vst1q_f16(output_block + (1 * OCVL()), vio[1]);
                    __attribute__((fallthrough));
                case 1:
            ...
            for (int64_t tile_l2 = 0; tile_l2 < num_tiles; tile_l2 += k_tile_l2) {
                ...
                for (int64_t ic_l2 = 0; ic_l2 < ic_g_packed; ic_l2 += k_in_channel_section) {
                    ...
                    for (int64_t oc_l2 = 0; oc_l2 < oc_g_packed; oc_l2 += k_out_channel_section) {
                        ...
                        const int64_t out_channel_section_align_2ocblk = (out_channel_section / 16) * 16;
...
static void hgemm_n8cx_fp16_blocking_an_inner_16x8(
    const __fp16 *a,
    __fp16 *converted_a,
    const int64_t lda,
    const int64_t m,
        ...
        for (int64_t set_id = 0; set_id < WGB4F3_NSET(); set_id++) {
            ...
            for (int64_t i = 0; i < oc_group; i += out_ch_section) {
                for (int64_t p = 0; p < ic_group_packed; p += in_ch_section) {
                    ...
                    hgemm_n8cx_fp16_blocking_an_inner_16x8(
...
ppl::common::RetCode conv2d_wgb4f3_fp16_offline_manager::fast_init_schedule_param()
{
    ...
    sched_param_.ic_blk   = 192;
    sched_param_.tile_blk = 140;

    if (sched_param_.oc_blk != 1024) {
        return ppl::common::RC_INVALID_VALUE;
    }
    if (sched_param_.ic_blk != 192) {
        return ppl::common::RC_INVALID_VALUE;
    }
    if (sched_param_.tile_blk != 140) {
        return ppl::common::RC_INVALID_VALUE;
    }
    return ppl::common::RC_SUCCESS;
}
    ...
    for (auto oc_blk : candidate_oc_blk_list) {
        for (auto ic_blk : candidate_ic_blk_list) {
            for (auto tile_blk : candidate_tile_blk_list) {
                ...
                if ((int64_t)tile_blk >= num_batch * ((src_h + 3) / 4) * ((src_w + 3) / 4)) break;
            }
            if ((int64_t)ic_blk >= channels / param_.group) break;
        }
        if ((int64_t)oc_blk >= num_output / param_.group) break;
    }
