...
typedef struct {
    ...
    int64_t ocblk2 = 16;
} conv2d_n8cx_direct_fp16_kernel_param;

typedef struct {
    // weight conversion related; should be assigend offline
    int64_t ic_tile;
} conv2d_n8cx_direct_fp16_schedule_param;

class conv2d_n8cx_direct_fp16_runtime_executor final : public conv2d_runtime_executor {
public:
    conv2d_n8cx_direct_fp16_runtime_executor() {}
    conv2d_n8cx_direct_fp16_runtime_executor(const conv2d_param *conv_param, const void *cvt_filter, const void *bias, conv2d_n8cx_direct_fp16_schedule_param sched_param)
...
private:
    const conv2d_n8cx_direct_fp16_kernel_param ker_param_;
...
private:
    friend conv2d_n8cx_direct_fp16_offline_manager;
};

class conv2d_n8cx_direct_fp16_offline_manager final : public conv2d_offline_manager {
public:
    conv2d_n8cx_direct_fp16_offline_manager() {}
