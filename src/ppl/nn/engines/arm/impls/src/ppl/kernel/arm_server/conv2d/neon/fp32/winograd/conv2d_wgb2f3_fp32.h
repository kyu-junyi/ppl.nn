...
#ifndef __ST_PPL_KERNEL_ARM_SERVER_CONV2D_NEON_FP32_WINOGRAD_CONV2D_WGB2F3_FP32_H_
#define __ST_PPL_KERNEL_ARM_SERVER_CONV2D_NEON_FP32_WINOGRAD_CONV2D_WGB2F3_FP32_H_
...
// forward declare;
class conv2d_wgb2f3_fp32_offline_manager;
...
typedef struct {
    ...
    int64_t tile_blk;
} conv2d_wgb2f3_fp32_schedule_param;

class conv2d_wgb2f3_fp32_runtime_executor final : public conv2d_runtime_executor {
public:
    conv2d_wgb2f3_fp32_runtime_executor() {}
    conv2d_wgb2f3_fp32_runtime_executor(const conv2d_param *conv_param, const void *cvt_filter, const void *bias, conv2d_wgb2f3_fp32_schedule_param sched_param)
...
private:
    conv2d_wgb2f3_fp32_schedule_param sched_param_;
    // adjust scheduling params if needed during preparation.
    void adjust_schedule_param();

    friend conv2d_wgb2f3_fp32_offline_manager;
};

class conv2d_wgb2f3_fp32_offline_manager final : public conv2d_offline_manager {
public:
    conv2d_wgb2f3_fp32_offline_manager() {}
