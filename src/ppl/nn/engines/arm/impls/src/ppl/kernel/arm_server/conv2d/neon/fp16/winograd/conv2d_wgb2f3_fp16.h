...
#ifndef __ST_PPL_KERNEL_ARM_SERVER_CONV2D_NEON_FP16_WINOGRAD_CONV2D_WGB2F3_FP16_H_
#define __ST_PPL_KERNEL_ARM_SERVER_CONV2D_NEON_FP16_WINOGRAD_CONV2D_WGB2F3_FP16_H_
...
// forward declare;
class conv2d_wgb2f3_fp16_offline_manager;
...
private:
    conv2d_wgb2f3_fp16_schedule_param sched_param_;
    // adjust scheduling params if needed during preparation.
    void adjust_schedule_param();

    friend conv2d_wgb2f3_fp16_offline_manager;
};

class conv2d_wgb2f3_fp16_offline_manager final : public conv2d_offline_manager {
public:
    conv2d_wgb2f3_fp16_offline_manager() {}
    conv2d_wgb2f3_fp16_offline_manager(const conv2d_param &param, ppl::common::Allocator *allocator)
