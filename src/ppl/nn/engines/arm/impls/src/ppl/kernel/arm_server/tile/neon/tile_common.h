...
#ifndef __ST_PPL_KERNEL_ARM_SERVER_TILE_NEON_TILE_COMMON_H_
#define __ST_PPL_KERNEL_ARM_SERVER_TILE_NEON_TILE_COMMON_H_
...
template <typename eT>
static ppl::common::RetCode tile_ndarray_common(
    const ppl::nn::TensorShape *src_shape,
    const ppl::nn::TensorShape *dst_shape,
    const eT *src,
    const int64_t *repeats,
