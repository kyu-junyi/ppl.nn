...
private:
    conv2d_n8cx_depthwise_fp16_schedule_param sched_param_;
    // adjust scheduling params if needed during preparation.
    void adjust_schedule_param();

    friend conv2d_n8cx_depthwise_fp16_offline_manager;
};

class conv2d_n8cx_depthwise_fp16_offline_manager final : public conv2d_offline_manager {
public:
    conv2d_n8cx_depthwise_fp16_offline_manager() {}
    conv2d_n8cx_depthwise_fp16_offline_manager(const conv2d_param &param, ppl::common::Allocator *allocator)
