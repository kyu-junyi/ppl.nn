            ...
            for (int64_t ic_l1 = 0; ic_l1 < inC; ic_l1 += icS) {
                ...
                for (int64_t oc_l1 = 0; oc_l1 < outC_pck; oc_l1 += ocS) {
                    ...
                    const ppl_kernel_arm_server_conv2d_fp16_conv_direct_ndarray_kernel_func_t * const conv_direct_kernel_func_table = 
                        (oc_remains > OCBLK()) ? ppl_arm_server_kernel_fp16_conv_direct_ndarray_oc16_kernel_func_table :
                                                 ppl_arm_server_kernel_fp16_conv_direct_ndarray_oc8_kernel_func_table;
                    const ppl_kernel_arm_server_conv2d_fp16_conv_direct_ndarray_h1w1_kernel_func_t conv_direct_kernel_h1w1_func = 
                        (oc_remains > OCBLK()) ? ppl_kernel_arm_server_conv2d_fp16_conv_direct_ndarray_h1w1_kernel<16> :
                                                 ppl_kernel_arm_server_conv2d_fp16_conv_direct_ndarray_h1w1_kernel<8>;
