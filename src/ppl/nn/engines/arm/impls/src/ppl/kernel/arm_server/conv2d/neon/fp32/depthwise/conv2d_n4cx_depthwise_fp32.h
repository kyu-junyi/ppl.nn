...
#ifndef __ST_PPL_KERNEL_ARM_SERVER_CONV2D_NEON_FP32_DEPTHWISE_CONV2D_N4CX_DEPTHWISE_FP32_H_
#define __ST_PPL_KERNEL_ARM_SERVER_CONV2D_NEON_FP32_DEPTHWISE_CONV2D_N4CX_DEPTHWISE_FP32_H_
...
} conv2d_n4cx_depthwise_fp32_schedule_param;

class conv2d_n4cx_depthwise_fp32_runtime_executor final : public conv2d_runtime_executor {
public:
    conv2d_n4cx_depthwise_fp32_runtime_executor() {}
    conv2d_n4cx_depthwise_fp32_runtime_executor(const conv2d_param *conv_param, const void *cvt_filter, const void *bias, conv2d_n4cx_depthwise_fp32_schedule_param sched_param)
...
private:
    ...
    friend conv2d_n4cx_depthwise_fp32_offline_manager;
};

class conv2d_n4cx_depthwise_fp32_offline_manager final : public conv2d_offline_manager {
public:
    conv2d_n4cx_depthwise_fp32_offline_manager() {}
    conv2d_n4cx_depthwise_fp32_offline_manager(const conv2d_param &param, ppl::common::Allocator *allocator)
