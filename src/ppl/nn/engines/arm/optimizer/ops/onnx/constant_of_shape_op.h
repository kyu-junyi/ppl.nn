...
#ifndef _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_ONNX_CONSTANT_OF_SHAPE_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_ONNX_CONSTANT_OF_SHAPE_OP_H_
...
private:
    std::shared_ptr<ppl::nn::onnx::ConstantOfShapeParam> param_;
};
