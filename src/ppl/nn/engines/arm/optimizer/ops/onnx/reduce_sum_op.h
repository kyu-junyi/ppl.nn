...
#ifndef _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_ONNX_REDUCE_SUM_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_ONNX_REDUCE_SUM_OP_H_
...
class ReduceSumOp final : public ArmOptKernel {
public:
    ReduceSumOp(const ir::Node* node);
