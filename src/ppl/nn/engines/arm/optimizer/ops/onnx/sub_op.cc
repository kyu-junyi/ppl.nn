...
SubOp::SubOp(const ir::Node* node) : ArmOptKernel(node) {
...
ppl::common::RetCode SubOp::SerializeData(const ::ppl::nn::pmx::SerializationContext& ctx, utils::DataStream* ds) const {
...
ppl::common::RetCode SubOp::DeserializeData(const ::ppl::nn::pmx::DeserializationContext& ctx, const void* base, uint64_t size) {
