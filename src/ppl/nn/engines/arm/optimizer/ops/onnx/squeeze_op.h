...
#ifndef _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_ONNX_SQUEEZE_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_ONNX_SQUEEZE_OP_H_
...
class SqueezeOp final : public ArmOptKernel {
public:
    SqueezeOp(const ir::Node* node);
...
private:
    std::shared_ptr<ppl::nn::onnx::SqueezeParam> param_;
};
