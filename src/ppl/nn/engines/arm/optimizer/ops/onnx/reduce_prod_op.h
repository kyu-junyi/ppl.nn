...
#ifndef _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_ONNX_REDUCE_PROD_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_ONNX_REDUCE_PROD_OP_H_
...
public:
    ReduceProdOp(const ir::Node* node);
