...
AddOp::AddOp(const ir::Node* node) : ArmOptKernel(node) {
...
ppl::common::RetCode AddOp::SerializeData(const ::ppl::nn::pmx::SerializationContext& ctx, utils::DataStream* ds) const {
...
ppl::common::RetCode AddOp::DeserializeData(const ::ppl::nn::pmx::DeserializationContext& ctx, const void* base, uint64_t size) {
