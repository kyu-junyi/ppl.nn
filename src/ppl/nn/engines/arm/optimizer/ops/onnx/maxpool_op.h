...
#ifndef _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_ONNX_MAXPOOL_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_ONNX_MAXPOOL_OP_H_
...
class MaxPoolOp final : public ArmOptKernel {
public:
    MaxPoolOp(const ir::Node* node);
