...
#ifndef _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_ONNX_REDUCE_MEAN_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_ONNX_REDUCE_MEAN_OP_H_
...
class ReduceMeanOp final : public ArmOptKernel {
public:
    ReduceMeanOp(const ir::Node* node);
