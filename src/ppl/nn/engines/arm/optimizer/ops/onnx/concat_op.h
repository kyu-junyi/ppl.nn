...
#ifndef _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_ONNX_CONCAT_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_ONNX_CONCAT_OP_H_
...
class ConcatOp final : public ArmOptKernel {
public:
...
private:
    std::shared_ptr<ppl::nn::onnx::ConcatParam> param_;
};
