...
#ifndef _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_PMX_CHANNEL_SHUFFLE_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_ARM_OPTIMIZER_OPS_PMX_CHANNEL_SHUFFLE_OP_H_
...
class ChannelShuffleOp final : public ArmOptKernel {
public:
    ChannelShuffleOp(const ir::Node* node);
...
private:
    std::shared_ptr<ppl::nn::pmx::ChannelShuffleParam> param_;
};
