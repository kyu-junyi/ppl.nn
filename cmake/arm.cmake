...
if(PPLNN_USE_ANDROID_NDK)
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wno-format -Wno-backslash-newline-escape")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wno-format -Wno-backslash-newline-escape -Wno-unused-lambda-capture")
...
target_compile_options(pplnn_arm_static PUBLIC ${PPL_KERNEL_ARMV8_2_MARCH})
